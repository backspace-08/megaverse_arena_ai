---
description: Test subject (FLAGSHIP - DeepSeek V4 Flash, official API) that plays COTE Megaverse against the bot and reports a win rate. Use when launching a subagent to play the game via play.py with --run deepseek-v4-flash-flagman.
mode: subagent
